...
const char *gpio_name[92][8] = {
 ...
 "NULL",                    "mcasp0_fsr",            "gpio2_1"},
    ...
    {"lcd_data15",      "gpmc_a19",                "eQEP1_strobe",     "mcasp0_ahclkx",    "mcasp0_axr3",            "NULL",                    "uart5_ctsn",            "gpio0_11"},
    {"lcd_data13",      "gpmc_a17",                "eQEP1B_in",        "mcasp0_fsr",       "mcasp0_axr3",            "NULL",                    "uart5_ctsn",            "gpio0_9"},
    {"lcd_data11",      "gpmc_a15",                "ehrpwm1B",            "mcasp0_ahclkr",    "mcasp0_axr2",            "NULL",                    "uart5_ctsn",            "gpio2_17"},
    {"lcd_data12",      "gpmc_a16",                "eQEP1A_in",        "mcasp0_aclkr",     "mcasp0_axr2",            "NULL",                    "uart5_ctsn",            "gpio0_8"},
    {"lcd_data10",      "gpmc_a14",                "ehrpwm1A",            "mcasp0_axr0",      "NULL",                    "NULL",                    "uart5_ctsn",            "gpio2_16"},
    {"lcd_data8",       "gpmc_a12",                "ehrpwm1_tripzone_in","mcasp0_aclkx",   "uart5_txd",            "NULL",                    "uart5_ctsn",            "gpio2_14"},
    {"lcd_data9",       "gpmc_a13",                "ehrpwm0_synco",    "mcasp0_fsx",       "uart5_rxd",            "NULL",                    "uart5_ctsn",            "gpio2_15"},
    {"lcd_data6",       "gpmc_a6",                "NULL",                "eQEP2_index",      "NULL",                    "NULL",                    "uart5_ctsn",            "gpio2_12"},
    {"lcd_data7",       "gpmc_a7",                "NULL",                "eQEP2_strobe",     "pr1_edio_data_out7",   "NULL",                    "uart5_ctsn",            "gpio2_13"},
    {"lcd_data4",       "gpmc_a4",                "NULL",                "eQEP2A_in",        "NULL",                    "NULL",                    "uart5_ctsn",            "gpio2_10"},
    {"lcd_data5",       "gpmc_a5",                "NULL",                "eQEP2B_in",        "NULL",                    "NULL",                    "uart5_ctsn",            "gpio2_11"},
    {"lcd_data2",       "gpmc_a2",                "NULL",                "ehrpwm2_tripzone_in","NULL",                "NULL",                    "uart5_ctsn",            "gpio2_8"},
    {"lcd_data3",       "gpmc_a3",                "NULL",                "ehrpwm0_synco",    "NULL",                    "NULL",                    "uart5_ctsn",            "gpio2_9"},
    {"lcd_data0",       "gpmc_a0",                "NULL",                "ehrpwm2A",         "NULL",                    "NULL",                    "uart5_ctsn",            "gpio2_6"},
    {"lcd_data1",       "gpmc_a1",                "NULL",                "ehrpwm2B",         "NULL",                    "NULL",                    "uart5_ctsn",            "gpio2_7"},
    {"GND",             "GND",                    "GND",                "GND",                "GND",                    "GND",                    "GND",                    "GND"},
    {"GND",             "GND",                    "GND",                "GND",                "GND",                    "GND",                    "GND",                    "GND"},
...
int gpio_set_mode(int connector, int pin, int mode)
{
    ...
    printf("%p\n", ctrl_addr + gpio_mode_offset[port]);
  #endif

    *(unsigned int *)(ctrl_addr + gpio_mode_offset[port]) = mode;
...
int gpio_get_dir(int connector, int pin)
{
    ...
    return (*reg >> gpio_bitfield[port]) & 0x1 ;
}
