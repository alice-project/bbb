...
public class DescriptorMatcher {
    ...
    public  void match(Mat queryDescriptors, MatOfDMatch matches, List<Mat> masks)
    {
        ...
        match_0(nativeObj, queryDescriptors.nativeObj, matches_mat.nativeObj, masks_mat.nativeObj);
    ...
    {
        Mat matches_mat = matches;
        match_1(nativeObj, queryDescriptors.nativeObj, matches_mat.nativeObj);
    ...
    {
        Mat matches_mat = matches;
        match_2(nativeObj, queryDescriptors.nativeObj, trainDescriptors.nativeObj, matches_mat.nativeObj, mask.nativeObj);
    ...
    {
        Mat matches_mat = matches;
        match_3(nativeObj, queryDescriptors.nativeObj, trainDescriptors.nativeObj, matches_mat.nativeObj);
    ...
    // C++:  void match(Mat queryDescriptors, vector_DMatch& matches, vector_Mat masks = std::vector<Mat>())
    private static native void match_0(long nativeObj, long queryDescriptors_nativeObj, long matches_mat_nativeObj, long masks_mat_nativeObj);
    private static native void match_1(long nativeObj, long queryDescriptors_nativeObj, long matches_mat_nativeObj);
    ...
    // C++:  void match(Mat queryDescriptors, Mat trainDescriptors, vector_DMatch& matches, Mat mask = Mat())
    private static native void match_2(long nativeObj, long queryDescriptors_nativeObj, long trainDescriptors_nativeObj, long matches_mat_nativeObj, long mask_nativeObj);
    private static native void match_3(long nativeObj, long queryDescriptors_nativeObj, long trainDescriptors_nativeObj, long matches_mat_nativeObj);
